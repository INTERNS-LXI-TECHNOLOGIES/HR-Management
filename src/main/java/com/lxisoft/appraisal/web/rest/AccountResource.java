...
import com.lxisoft.appraisal.domain.PersistentToken;
...
import com.lxisoft.appraisal.service.MailService;
import com.lxisoft.appraisal.service.UserService;
import com.lxisoft.appraisal.service.dto.PasswordChangeDTO;
import com.lxisoft.appraisal.service.dto.UserDTO;
import com.lxisoft.appraisal.web.rest.errors.*;
import com.lxisoft.appraisal.web.rest.vm.KeyAndPasswordVM;
import com.lxisoft.appraisal.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid  ManagedUserVM managedUserVM) {
        if (!checkPasswordLength(managedUserVM.getPassword())) {
            throw new InvalidPasswordException();
        }
        User user = userService.registerUser(managedUserVM, managedUserVM.getPassword(),(managedUserVM.getCompany()), (managedUserVM.getPosition()),
                (managedUserVM.getJoiningDate()), (managedUserVM.getDob()), (managedUserVM.getImage()), (managedUserVM.getImageContentType()), (managedUserVM.getUsername()));
