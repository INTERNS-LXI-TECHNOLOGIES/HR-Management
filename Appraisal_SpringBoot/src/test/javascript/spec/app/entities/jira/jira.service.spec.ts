...
describe('Service Tests', () => {
  describe('Jira Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(JiraService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Jira(0, currentDate, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Jira', () => {
        ...
        service.create(new Jira()).subscribe(resp => (expectedResult = resp.body));
